...
export default function AdminToolbar({ username, onAdd, onLogout, loggingOut }: Props) {
  return (
    <div className="mb-6 flex flex-col gap-4 rounded-[10px] border border-brand-blue/20 bg-brand-blue/[0.045] p-4 sm:flex-row sm:items-center sm:justify-between dark:border-brand-blue-light/20 dark:bg-brand-blue-light/[0.06]">
      <div className="flex items-center gap-3">
        <span className="grid size-10 place-items-center rounded-[8px] bg-brand-blue text-white"><ShieldCheck size={18} /></span>
        <div>
